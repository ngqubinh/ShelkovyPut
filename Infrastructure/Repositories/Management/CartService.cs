...
namespace Infrastructure.Repositories.Management
{
    public class CartService : ICartService
    {
        ...
        public CartService(ShelkobyPutDbContext context, IHttpContextAccessor http, UserManager<User> userManager)
        {
            _context = context;
            _http = http;
        ...
        public async Task<bool> DoCheckout(CheckoutRequest model)
        {
            ...
            try
            {
                ...
                var order = new Order()
                {
                    ...
                    {
                        Id = model.Address.Id,
                        Settlement = model.Address.Settlement,  
                        District = model.Address.District,
                        Province = model.Address.Settlement,
